 ...
 * @author Macky Server
 */
public class documentdata extends javax.swing.JInternalFrame {
    ...
    public void displayData() {
        try {
            ...
            allusers.setModel(DbUtils.resultSetToTableModel(rs));
            rs.close();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {
        JOptionPane.showMessageDialog(this, "Add functionality goes here");
        // Implement add dialog or form
    }

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {
        JOptionPane.showMessageDialog(this, "Edit functionality goes here");
        // Implement edit logic (fetch selected row, update database)
    }

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {
        int selectedRow = allusers.getSelectedRow();
        if (selectedRow != -1) {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                int id = (int) allusers.getValueAt(selectedRow, 0); // Assuming first column is ID
                dbConnector dbc = new dbConnector();
                dbc.updateData("DELETE FROM tbl_documents WHERE d_id = " + id);
                displayData();
            }
        } else {
